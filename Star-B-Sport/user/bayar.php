...
<body>
  ...
  <section class="lapangan_212279 mb-5" id="lapangan_212279">
    <div class="container-fluid">
      ...
      <h2 class="text-head" align="center"><span>Pembayaran</span> Lapangan </h2>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row justify-content-center align-items-center">
                              ...
                              <div class="mt-3">
                                <label for="exampleInputPassword1" class="form-label">Transfer ke : BTN 17701610003085 a/n Star-b Sport</label>
                              </div>
                              <div class="mt-3">
